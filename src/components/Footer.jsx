            ...
            <div className="footer__inner container">
                <div className="footer__top">
                    <div className="footer__brand">
                        <a href="#" className="footer__logo">
                            ...
                            <span className="footer__logo-text">TSM</span>
                        </a>
                        <p className="footer__tagline">
                            The Smart Mate.<br />Your personal AI companion.
                        </p>
                    ...
                    <div className="footer__links-grid">
                        {Object.entries(footerLinks).map(([category, links]) => (
                            <div className="footer__links-column" key={category}>
                ...
                <div className="footer__bottom">
                    <p className="footer__copyright">
                        &copy; {new Date().getFullYear()} TSM — The Smart Mate. All rights reserved.
                    </p>
                    <p className="footer__made">
                        Built with ♥ by Team TSM.
                    </p>
                </div>
            </div>
        </footer>
